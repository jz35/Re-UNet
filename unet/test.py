...
def get_logits(output):
    """Handle models that optionally return (logits, aux_loss)."""
...
if __name__ == "__main__":
    ...
    print(
        f"Jaccard: {jaccard:.4f} - F1: {f1:.4f} - Recall: {recall:.4f} - "
    ...
    curve_path = os.path.join(results_dir, "unet_test_curves.png")
    plot_test_curves(sample_losses, sample_accs, curve_path, "U-Net")
